...
/// Category for offline-only BTAPIClient methods
///
/// Do not use this in production.
///
/// @see BTOfflineModeURLProtocol
@interface BTAPIClient (Offline)
...
+ (NSString *)offlineTestClientTokenWithAdditionalParameters:(NSDictionary *)configuration DEPRECATED_MSG_ATTRIBUTE("Offline BTAPIClient is no longer supported. Please use a real client token by on your server. (See https://developers.braintreepayments.com/ios/sdk/overview/generate-client-token)");
