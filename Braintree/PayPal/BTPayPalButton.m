...
- (void)didReceiveTouch {
    if (self.client == nil) {
        [[BTLogger sharedLogger] warning:@"BTPayPalButton tapped without a client. You must assign a BTAPIClient to the the BTPayPalButton before it requests presents presentation of the PayPal view controller."];
        return;
    }
